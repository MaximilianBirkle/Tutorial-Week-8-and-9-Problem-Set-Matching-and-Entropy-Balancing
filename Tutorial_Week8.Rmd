...
# Extract the balance table from synth output
...
balance_df <- data.frame(
  ...
  Synthetic_West_Germany = balance_table$tab.pred[, 2],
  OECD_Sample = balance_table$tab.pred[, 3]
)
...
knitr::kable(
  ...
  format = "latex",
  digits = 1,
  col.names = c("Predictor", "West Germany", "Synthetic West Germany", "OECD Sample"),
  caption = "Table: Economic Growth Predictor Means Before German Reunification",
  align = c("l", "r", "r", "r")
) %>%
  ...
  kableExtra::footnote(
    general = "GDP per capita, inflation rate, trade openness, and industry share are averaged for the 1981-1990 period. Investment rate and schooling are averaged for the 1980-1985 period. The OECD Sample column reports a population-weighted average for the 16 OECD countries in the donor pool.",
    general_title = "Note:",
