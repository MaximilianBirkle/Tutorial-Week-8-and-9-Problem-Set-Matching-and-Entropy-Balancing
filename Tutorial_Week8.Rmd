...
This is a classic "what-is-going-on" moment, but we have to be extremely clear: neither of these numbers is a credible causal estimate.
This isn't just a minor technicality. Our diagnostic analysis in Q3 was a definitive finding that our matching procedure failed. Those Love plots (like image_81f4dc.png) showed conclusively that our "matched" samples are still severely imbalanced on key, powerful confounders like the start year (t0) and whether the conflict was internationalized (inter).
